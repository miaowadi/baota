...
# 			download_Url="https://bt11d1.bthappy.com"
# 		fi
...
Install_RPM_Pack(){
	...
	#	curl -Ss --connect-timeout 3 -m 60 https://bt11d1.bthappy.com/install/yumRepo_select.sh|bash
	#fi
...
Install_Bt(){
	...
	echo "正在下载面板文件,请稍等..................."
	echo "=============================================="
	wget -O panel.zip ${Down_Url}/install/src/panel6.zip -T 15
...
Get_Ip_Address(){
	...
	CN_CHECK=$(curl -sS --connect-timeout 10 -m 10 https://bt11n.bthappy.com/api/isCN)
	if [ "${CN_CHECK}" == "True" ];then
